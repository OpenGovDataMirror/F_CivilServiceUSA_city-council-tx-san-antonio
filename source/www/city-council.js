  ...
  $.getJSON('city-council/data/city-council-data.json', function( data ) {
    ...
    $.each( data, function( key, val ) {
      ...
      var jsonld = {
        ...
        "url": "https://civilserviceusa.github.io/city-council-tx-san-antonio/",
        "sameAs": []
      };
      ...
      jsonld.image = 'https://civilserviceusa.github.io/city-council-tx-san-antonio/images/headshots/512x512/' + val.name_slug + '.jpg';
      jsonld.jobTitle = toTitleCase(val.title) + ' of San Antonio City Council';
